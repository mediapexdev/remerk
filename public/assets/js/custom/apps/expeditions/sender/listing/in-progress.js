    ...
    return {
        init: function () {
            ...
            (   (d_table = $(table).DataTable({
                ...
                (() => {
                    const order_filter_matiere = document.querySelector('[data-kt-expeditions-in-progress-filter="matiere"]');
                ...
                document.querySelector('[href="#kt_tab_expeditions_in_progress"]')
