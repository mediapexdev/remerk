"use strict";
const KTAppPendingExpeditionsListing = (function () {
    let table,
        d_table,
        flatpickr_object,
        date_start,
    ...
    return {
        init: function () {
            (table = document.querySelector("#kt_expeditions_en_attente_table")) &&
            (   (d_table = $(table).DataTable({
                ...
                (() => {
                    const e = document.querySelector("#kt_pending_expeditions_flatpickr");
                ...
                document.querySelector('[data-kt-pending-expeditions-filter="search"]')
                .addEventListener("keyup", function (e) {
                    d_table.search(e.target.value).draw();
                }),
                /*(() => {
                    const order_filter_matiere = document.querySelector('[data-kt-pending-expeditions-filter="matiere"]');
                ...
                document.querySelector("#kt_pending_expeditions_flatpickr_clear")
                .addEventListener("click", (e) => {
                    flatpickr_object.clear();
                })
                ,
                document.querySelector('[href="#rk_tab_pending_expeditions"]')
...
KTUtil.onDOMContentLoaded(function () {
    KTAppPendingExpeditionsListing.init();
});
