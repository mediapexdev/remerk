    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        ...
        <form id="kt_account_profile_details_form" class="form" method="POST"
            ...
            <div class="card-body border-top p-9">
                    ...
                    <div class="col-lg-8 fv-row">
                        ...
                        <div id="kt_avatar_input" class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url('{{ $avatar }}'); background-position: center center;">
                            </div>
                ...
                {{-- <!--end::Input group--> --}}
                {{-- <!--begin::Modal--> --}}
                @include('components.account.settings.confirm-profile-details')
                {{-- <!--end::Modal--> --}}
            </div>
            {{-- <!--end::Card body--> --}}
            {{-- <!--begin::Actions--> --}}
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                ...
                <button type="reset" class="btn btn-light btn-active-light-primary clear-on-dark me-2">Annuler</button>
