    ...
    <div class="d-flex flex-column">
        ...
        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
            <div class="d-flex align-items-center text-gray-600 text-gray-700-on-dark me-5 mb-2">
                ...
                <span class="svg-icon svg-icon-4 me-1 text-gray-600 text-gray-700-on-dark">
            ...
            <div class="d-flex align-items-center me-5 mb-2 text-gray-600 text-gray-700-on-dark">
            ...
            <div class="d-flex align-items-center text-gray-600 text-gray-700-on-dark me-5 mb-2">
                ...
                {{-- <!--end::Svg Icon--> --}}
                <span>{{Auth::user()->formattedPhoneNumber()}}</span>
            </div>
            {{-- @if (Auth::user()->hasEmail())
            <div class="d-flex align-items-center text-gray-600 text-gray-700-on-dark mb-2">
