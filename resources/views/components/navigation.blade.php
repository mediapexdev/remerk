...
<body class="">
    ...
    <div class="mb-10"></div>
    <div id="kt_app_header container-fluid" class="app-header fixed-top " style="margin:0 auto; width:100%">
        ...
        <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
            ...
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                <a href="/dashboard" class="d-lg-none">
                    <img alt="Logo" src="assets/images/Logo-Officiel---R-Monochrome-Blanc.png" class="h-50px theme-dark-show" />
                    <img alt="Logo" src="assets/images/Logo-Officiel-Normal.png" class="h-50px theme-light-show" />
                </a>
            </div>
            <!--end::Mobile logo-->
            ...
            <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                ...
                <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                    ...
                    <a class="theme-dark-show">
                        <img alt="Logo" src="assets/images/Logo-Officiel---Monochrome-Blanc.png"
                            class="h-45px img-fluid mt-2" />
                    </a>
                    <a class="theme-light-show">
                        <img alt="Logo" src="assets/images/Logo-2.png" class="h-45px img-fluid mt-2" />
                    </a>
                    ...
                    <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <span class="menu-link">
                                <a href="/dashboard" ><span class="menu-title">Dashboard</span></a>
                            </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <a ><span class="menu-title">Facuration</span></a>
                            </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <!--begin:Menu item-->
                        <div
                            data-kt-menu-placement="bottom-start" class="menu-item {{-- here show --}}">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <a data-bs-toggle="modal" data-bs-target="#kt_modal_create_app"><span class="btn btn-sm fw-bold btn-primary ">Expedition</span></a>
                            </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                    ...
                    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="menu-link d-flex px-5">
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1 selected" src="assets/media/flags/france.svg"
                                                    alt="" />
                                            </span>Français</a>
                                    </div>
                                    <!--end::Menu item-->
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="/profile/setting">Paramétre du compte</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                ...
                                <a onclick="document.querySelector('#logout-form').submit();"
                                    class="menu-link px-5">Se
                                    deconnecter</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
