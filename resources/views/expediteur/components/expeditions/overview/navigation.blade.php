<ul id="expeditions_overview_nav" class="nav nav-pills nav-pills-custom item position-relative mx-9 mb-9">
    ...
    <li class="nav-item col-4 mx-0 p-0">
        {{-- <!--begin::Link--> --}}
        <a class="nav-link active d-flex justify-content-center w-100 border-0 h-100" data-bs-toggle="pill" href="#kt_tab_expeditions_en_attente">
            {{-- <!--begin::Subtitle--> --}}
            <span class="nav-text text-gray-800 fw-bold fs-6 mb-3">En attente</span>
            {{-- <!--end::Subtitle--> --}}
            {{-- <!--begin::Bullet--> --}}
