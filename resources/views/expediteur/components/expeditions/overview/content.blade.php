...
<div class="timeline ms-n1">
    ...
    <div class="timeline-item align-items-center mb-4">
        ...
        <div class="timeline-content m-0">
            ...
            {{-- <!--begin::Label--> --}}
            {{-- <!--begin::Title--> --}}
            <span class="full-address fs-6 text-gray-600 fw-semibold d-block">{{ $expedition->adresseDepartComplet() }}</span>
            {{-- <!--end::Title--> --}}
            {{-- <!--begin::Sub Title--> --}}
            <span class="short-address fs-6 fw-bold text-gray-800">{{ $expedition->depart->commune->nom }}</span>
            {{-- <!--end::Sub Title--> --}}
        </div>
    ...
    <div class="timeline-item align-items-center">
        ...
        <div class="timeline-content m-0">
            ...
            {{-- <!--begin::Label--> --}}
            {{-- <!--begin::Title--> --}}
            <span class="full-address fs-6 text-gray-600 fw-semibold d-block">{{ $expedition->adresseArriveeComplet() }}</span>
            {{-- <!--end::Title--> --}}
            {{-- <!--begin::Sub Title--> --}}
            <span class="short-address fs-6 fw-bold text-gray-800">{{ $expedition->arrivee->commune->nom }}</span>
            {{-- <!--end::Sub Title--> --}}
        </div>
        {{-- <!--end::Timeline content--> --}}
    </div>
