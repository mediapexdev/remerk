...
$avatar = Util::getDefaultUserAvatar();
$transporteur = $expedition->transporteur;

if ($transporteur && $transporteur->hasAvatar()) {
                    ...
                    <tr>
                        ...
                        <td class="text-gray-700 fw-bold text-end">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                {{--
                                <!--begin::Full Name--> --}}
                                <span class="text-gray-700">Aucun pour le moment</span>
                                {{--
                                <!--end::Full Name--> --}}
                            </div>
                        </td>
                    ...
                    <tr>
                        <td class="text-gray-700 text-muted" scope="row">
                            <div class="d-flex align-items-center">
                                ...
                                --}}
                                <span class="svg-icon svg-icon-2 me-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 576"
                                        fill="currentColor">
                                        <path
                        ...
                        <td class="fw-bold text-end">
                            <span>{{ (new \DateTime($expedition->scheduledDate(), new
