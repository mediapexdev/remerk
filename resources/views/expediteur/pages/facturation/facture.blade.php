                ...
                <div class="card-body pt-0">
                    ...
                    <table id="kt_factures_table" class="table table-sm align-middle table-row-dashed">
                        ...
                        <tbody class="fs-6 fw-semibold text-gray">
                            @foreach ($expeditions as $expedition)
                                @php
                                    $factures = Facture::where('expedition_id', $expedition->id)->orderByDesc('created_at')->get();
                                @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div id="transporteur_avatar_{{ $transporteur->id }}"
                                            ...
                                            data-method="GET" data-route="{{ route('transporteur.details', $transporteur->id) }}">
                                        ...
                                        <div class="ms-5">
                                            <span id="transporteur_title_{{ $transporteur->id }}"
                                                ...
                                                data-route="{{ route('transporteur.details', $transporteur->id) }}">{{ $transporteur->fullName() }}</span>
                                        </div>
                                        {{-- <!--end::Title--> --}}
                                    </div>
                                </td>
                                ...
                                {{-- <!--end::Date--> --}}
                                <td>
                                    <button type="button" class="btn btn-sm btn-light-primary btn_action_facture" data-facture-id="{{$facture->id}}">
                                        @if(1 == $facture->etat)
                                            Payer
                                        @else
                                            Voir
                                        ...
                                        <div>
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_create_expedition">Faire une expedition</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
