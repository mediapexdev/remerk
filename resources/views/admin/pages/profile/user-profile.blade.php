...
@section('title')
<title>Remerk - Mon compte</title>
@endsection

@section('styles')
    <link type="text/css" rel="stylesheet" href="assets/plugins/custom/datatables/datatables.bundle.css">
    {{-- <link type="text/css" rel="stylesheet" href="src/sass/vendors/plugins/_select2.scss"> --}}
    <link type="text/css" rel="stylesheet" href="assets/css/custom/utilities/modals/create-expedition.css">
@endsection

@section('content')
<!--begin::App-->
<div class="d-flex flex-column flex-root app-root pt-10" id="kt_app_root" id="kt_app_body" class="app-default">
	<!--begin::Page-->
				...
				<div class="d-flex flex-column flex-column-fluid">
					...
					<div id="kt_app_content" class="app-content flex-column-fluid">
						...
						<div id="kt_app_content_container" class="app-container container-xxl">
									...
									<div class="d-flex flex-wrap flex-sm-nowrap mb-3">
										...
										<div class="me-7 mb-4">
											<div
												...
												<img src="assets/media/avatars/yoro.jpg" alt="image" />
												<div
											...
											<div
												...
												<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-2">
														<a class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{Auth::user()->prenom}}
															{{Auth::user()->nom}}</a>
														<a>
									...
									<ul
										...
										<li class="nav-item mt-2">
											<a class="nav-link text-active-primary ms-0 me-10 py-5 active"
												onClick="show_overview()" type="button" id="btn_account_overview" >Mon compte</a>
										...
										<li class="nav-item mt-2">
											...
											onClick="show_setting()" type="button" id="btn_account_setting">Paramètre du compte</a>
										</li>
										<!--end::Nav item-->
									</ul>
									<!--begin::Navs-->
							...
							<!--end::Navbar-->
							<!--begin::details View-->
							<div class="d-block" id="account_overview">
								@include('admin.components.account-overview')
							</div>
							<div class="d-none" id="account_setting">
								@include('admin.components.account-settings')
							</div>
							<!--end::details View-->
						</div>
...
<!--end::App-->
<!--begin::Components-->
@include('admin.components.components')
<!--end::Components-->
