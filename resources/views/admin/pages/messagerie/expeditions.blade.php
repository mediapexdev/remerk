                                        ...
                                        <div class="card card-flush h-xl-100">
                                            ...
                                            <div class="card-header pt-5">
                                                ...
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-800">Répartition des
                                                        expéditions</span>
                                                ...
                                                <ul class="nav nav-pills nav-pills-custom mb-3">
                                                    ...
                                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                                        ...
                                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 active"
                                                            ...
                                                            <!--end::Icon-->
                                                            <!--begin::Title-->
                                                            <span class="nav-text text-gray-400 fw-bold fs-6 lh-1">En
                                                                attente</span>
                                                            <!--end::Title-->
                                                            <!--begin::Bullet-->
                                                            <span
                                                    ...
                                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                                        ...
                                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                                            ...
                                                            <!--end::Icon-->
                                                            <!--begin::Title-->
                                                            <span class="nav-text text-gray-400 fw-bold fs-5 lh-1">En
                                                                cours</span>
                                                            <!--end::Title-->
                                                            <!--begin::Bullet-->
                                                            <span
                                                    ...
                                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                                        ...
                                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                                            ...
                                                            <!--begin::Title-->
                                                            <span
                                                                class="nav-text text-gray-400 fw-bold fs-6 lh-1">Terminées</span>
                                                            <!--end::Title-->
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                                    ...
                                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                                        ...
                                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                                            ...
                                                            <!--begin::Title-->
                                                            <span
                                                                class="nav-text text-gray-400 fw-bold fs-6 lh-1">Annulées</span>
                                                            <!--end::Title-->
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                                    ...
                                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                                        ...
                                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2"
                                                            ...
                                                            <!--begin::Title-->
                                                            <span
                                                                class="nav-text text-gray-400 fw-bold fs-6 lh-1">Others</span>
                                                            <!--end::Title-->
                                                            <!--begin::Bullet-->
                                                            <span
                                                                class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                                            ...
                                                            <table
                                                                ...
                                                                <thead>
                                                                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                                        <th class="p-0 pb-3 min-w-150px text-start">AUTHOR
                                                                        </th>
...
@section('custom-js')
    @include('admin.components.components.scripts')
@endsection
