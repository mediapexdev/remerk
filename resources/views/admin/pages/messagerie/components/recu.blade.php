@php
    ...
    $messages = Reponse::where('type', 1)->get();
@endphp
@extends('admin.layout')

@section('title')
    <title>Messages reçus | Remërk</title>
@endsection
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Messages reçus
                    <sup>
                ...
                <table class="table table-hover table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                    ...
                    <thead>
                        <tr class="fw-bold text-muted">
                            ...
                            <th class="min-w-100px">Prénom & Nom</th>
                            <th class="min-w-250px">Messages</th>
