...
<div id="kt_app_header" class="app-header">
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a class="theme-dark-show d-lg-none">
                <img src="{{URL::asset('assets/images/Logo-Officiel---Monochrome-Blanc.png') }}"
                    class="h-45px img-fluid mt-2" alt="Logo" title="Logo">

            </a>
            <a class="theme-light-show d-lg-none">
                <img src="{{ URL::asset('assets/images/Logo-2.png') }}" class="h-45px img-fluid mt-2" alt="Logo"
                    title="Logo">
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <a href="/">
                            <span class="menu-link {{ '/' == request()->path() ? 'active' : "" }}">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <a href={{ route('expeditions') }}>
                            <span class="menu-link {{ 'expeditions' == request()->path() ? 'active' : "" }}">
                                <span class="menu-title">Expeditions</span>
                            </span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        <!--begin:Menu link-->
                        <a href="/messagerie">
                            <span class="menu-link {{ 'messagerie' == request()->path() ? 'active' : "" }}">
            ...
            <div class="app-navbar flex-shrink-0">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <img src={{URL::asset("assets/media/avatars/300-6.jpg")}} alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src={{URL::asset("assets/media/avatars/300-2.jpg")}} alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src={{URL::asset("assets/media/avatars/300-9.jpg")}} alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src={{URL::asset("assets/media/avatars/300-14.jpg")}} alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src={{URL::asset("assets/media/avatars/300-11.jpg")}} alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-column justify-content-start fw-semibold">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src={{URL::asset("assets/media/svg/brand-logos/volicity-9.svg")}}
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src={{URL::asset("assets/media/svg/brand-logos/tvit.svg")}}
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src={{URL::asset("assets/media/svg/misc/infography.svg")}}
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src={{URL::asset("assets/media/svg/brand-logos/leaf.svg")}}
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src={{URL::asset("assets/media/svg/brand-logos/tower.svg")}}
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <img src={{URL::asset("assets/media/avatars/yoro.jpg")}} alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src={{URL::asset("assets/media/avatars/yoro.jpg")}} />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ Auth::user()->prenom }}
                                        {{ Auth::user()->nom }}
                                    </div>
                                    <a class="fw-semibold text-muted text-hover-primary fs-7">Téléphone :
                                        {{ Auth::user()->phone }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="/profile" class="menu-link px-5">Mon compte</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a class="menu-link px-5">
                                <span class="menu-text">Mes expeditions</span>
                                ...
                                <span class="menu-title position-relative">Langue
                                    <span
                                        ...
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src={{URL::asset("assets/media/flags/united-states.svg")}} alt="" /></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src={{URL::asset("assets/media/flags/spain.svg")}} alt="" />
                                        </span>Spanish</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src={{URL::asset("assets/media/flags/germany.svg")}} alt="" />
                                        </span>German</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src={{URL::asset("assets/media/flags/japan.svg")}} alt="" />
                                        </span>Japanese</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1 selected" src={{URL::asset("assets/media/flags/france.svg")}}
                                                alt="" />
                                        </span>Français</a>
                                </div>
                                <!--end::Menu item-->
                        ...
                        <div class="menu-item px-5">
                            ...
                            <a onclick="document.querySelector('#logout-form').submit();" class="menu-link px-5">Se
                                deconnecter</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
