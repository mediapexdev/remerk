...
<div class="search_box_wrapper">
    ...
    <div class="d-flex align-items-center position-relative my-1 col">
        ...
        <input type="text" class="form-control form-control-solid w-275px ps-14"
            placeholder="Recherche" data-kt-expeditions-in-progress-filter="search">
    </div>
    {{-- <!--end::Search--> --}}
</div>
    ...
    <div class="d-flex flex-row-fluid flex-wrap align-items-center gap-5">
        ...
        <div class="input-group w-275px">
            ...
            <select class="form-select form-select-solid" data-control="select2"
                data-hide-search="false" data-allow-clear="true" data-placeholder="Etat"
                data-kt-expeditions-in-progress-filter="status" aria-controls="kt_expeditions_en_cours_table">
                <option></option>
                <option value="all">Tout</option>
                @foreach ($etat_expeditions as $etat_expedition)
                    <option value="{{$etat_expedition->nom}}">{{$etat_expedition->nom}}</option> 
                @endforeach
            </select>
            {{-- <!--end::Select2--> --}}
        </div>
