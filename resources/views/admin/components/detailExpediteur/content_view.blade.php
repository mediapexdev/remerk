...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="d-flex flex-column flex-xl-row">
            @include('admin.components.detailExpediteur.fiche_user_item')
            <!--begin::Content-->
            <div class="flex-lg-row-fluid ms-lg-15">
                @include('admin.components.detailExpediteur.nav_menu')
                <!--begin:::Tab content-->
                <div class="tab-content" id="myTabContent">
                    @include('admin.components.detailExpediteur.content.overview')
                    @include('admin.components.detailExpediteur.content.general_settings')
                    @include('admin.components.detailExpediteur.content.security_settings')
                </div>
                <!--end:::Tab content-->
            </div>
            <!--end::Content-->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_modal_update_password_form" class="form"
                            ...
                            @csrf
                            <input type="hidden" name="phone" value="{{$expediteur->user->phone}}">
                            <!--begin::Input group=-->
                        ...
                        <form id="kt_modal_update_phone_form" class="form"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input class="form-control form-control-solid"
                                    ...
                                    value="{{$expediteur->user->phone}}" />
                                <!--end::Input-->
                                <input type="hidden" name="old_phone" value="{{$expediteur->user->phone}}">
                            </div>
                            <!--end::Input group-->
                            <!--begin::Actions-->
                            <div class="text-center pt-15">
