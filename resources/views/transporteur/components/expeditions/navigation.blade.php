<ul id="expeditions_nav" class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-0 fs-5 fw-semibold mb-8 mb-xl-10">
    ...
    <li class="nav-item mt-2">
        {{-- <!--begin::Link--> --}}
        <a class="nav-link text-gray-700 text-gray-900-on-dark ms-0 me-10 py-5 active" href="#kt_tab_available_expeditions" data-bs-toggle="tab">Disponibles
    ...
    <li class="nav-item mt-2">
        {{-- <!--begin::Link--> --}}
        <a class="nav-link text-gray-700 text-gray-900-on-dark ms-0 me-10 py-5" href="#kt_tab_expeditions_in_progress" data-bs-toggle="tab">En cours
    ...
    <li class="nav-item mt-2">
        {{-- <!--begin::Link--> --}}
        <a class="nav-link text-gray-700 text-gray-900-on-dark ms-0 me-10 py-5" href="#kt_tab_expeditions_made" data-bs-toggle="tab">Effectuées
