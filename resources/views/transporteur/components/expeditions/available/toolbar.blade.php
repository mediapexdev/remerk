...
<div class="search_box_wrapper">
    ...
    <div class="d-flex align-items-center position-relative my-1 col">
        ...
        <input type="text" class="form-control form-control-solid w-275px ps-14"
            placeholder="Recherche" data-kt-available-expeditions-filter="search">
    </div>
    {{-- <!--end::Search--> --}}
</div>
...
<div class="filters_wrapper">
    <div class="d-flex flex-row-fluid flex-wrap align-items-center gap-5">
        ...
        <div class="input-group w-275px">
            <input id="kt_available_expeditions_flatpickr"
                class="form-control form-control-solid rounded rounded-end-0" placeholder="Choisir une plage de dates">
            <button id="kt_available_expeditions_flatpickr_clear" class="btn btn-icon btn-light">
        ...
        <div class="input-group w-275px">
            ...
            <select class="form-select form-select-solid" data-control="select2"
                data-hide-search="false" data-allow-clear="true" data-placeholder="Produit/Matériel"
                data-kt-available-expeditions-filter="matiere" aria-controls="kt_expeditions_disponiles_table">
                <option></option>
