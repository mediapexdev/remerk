...
<div class="stepper-item mx-8 my-4 {{$status_class}}" data-kt-stepper-element="nav">
    ...
    <div class="stepper-wrapper d-flex flex-column align-items-center">
        ...
        <div class="stepper-label align-items-center py-4">
            ...
            <!--end::Line-->
            <h6 class="stepper-title fs-5">Déchargement</h6>
            <div class="stepper-desc">{{ (!isset($expedition_tracking) || !isset($expedition_tracking->date_dechargement)) ? '----------' : \date('d-m-Y', \strtotime($expedition_tracking->date_dechargement)) }}</div>
        </div>
        <!--end::Label-->
    </div>
    <!--end::Wrapper-->
