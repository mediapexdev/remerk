<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-body pt-10 pb-0">
        ...
        <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-semibold">
                 ...
                 <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                        data-bs-toggle="tab" href="#kt_expedition_tracking">Suivi</a>
                </li>
                {{-- <!--end:::Tab item--> --}}
                {{-- <!--begin:::Tab item--> --}}
                <li class="nav-item mt-2">
            ...
            {{-- <!--end:::Tabs--> --}}
            {{-- <!--begin::Button--> --}}
            <a class="btn btn-light btn-light-primary btn-sm ms-auto me-lg-n7" href="{{route('expeditions')}}" title="Retour">
