...
<div class="card card-flush overflow-hidden h-100">
    ...
    <div class="card-header pt-5">
        ...
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="text-gray-400 mt-1 fw-semibold fs-6"> expédition(s)</span>
        </h3>
        <!--end::Title-->
        <!--begin::Toolbar-->
    ...
    <div class="card-body d-flex align-items-end p-0">
        <!--begin::Chart-->
        <div id="rk_performance_transporteur" class="min-h-auto w-100 ps-4 pe-6" style="height: 300px"></div>
        <!--end::Chart-->
    </div>
    <!--end::Card body-->
</div>
