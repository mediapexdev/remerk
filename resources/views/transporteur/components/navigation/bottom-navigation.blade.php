    {{-- <!--begin::Menu--> --}}
    <div class="menu menu-rounded menu-lg-row my-0 my-lg-0 align-items-stretch bg-light-success fixed-bottom fw-semibold px-2 px-lg-0 bottom-0 d-xxl-none" data-kt-menu="true">
        {{-- <!--begin:Menu item--> --}}
