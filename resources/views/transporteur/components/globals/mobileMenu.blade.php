...
<nav class="app-footer navbar navbar-expand fixed-bottom d-lg-none d-xl-none d-xxl-none p-0 h-55px">
    <ul class="navbar-nav nav-justified w-100">
        <li class="nav-item menu-here-bg">
            <a href="/" class="text nav-link text-center bg-active-light {{ '/' == request()->path() ? 'active' : '' }}">
                ...
                <!--end::Svg Icon-->
                <span class="theme-light-show small menu-title d-block">Dashboard</span>
                <span class="theme-dark-show small menu-title text-white d-block">Dashboard</span>
            </a>
        </li>
        <li class="nav-item">
            <a href={{ route('expeditions') }} class="nav-link text-center bg-active-light border-active {{ 'expeditions' == request()->path() ? 'active' : '' }}">
                ...
                <!--end::Svg Icon-->
                <span class="theme-light-show small menu-title d-block">Expéditions</span>
                <span class="theme-dark-show small menu-title text-white d-block">expéditions</span>
            </a>
        </li>
        <li class="nav-item">
            <a href={{ route('vehicules') }} class="nav-link text-center bg-active-light {{ 'vehicules' == request()->path() ? 'active' : '' }}">
                <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-11-29-094551/core/html/src/media/icons/duotune/ecommerce/ecm006.svg-->
                <span class="svg-icon  svg-icon-2x svg-icon-gray-800"><svg width="16" height="16" viewBox="0 0 24 24"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <!--end::Svg Icon-->
                <span class="theme-light-show small menu-title d-block">Véhicules</span>
                <span class="theme-dark-show small menu-title text-white d-block">Véhicules</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="" class="nav-link text-center bg-active-light {{ 'aide' == request()->path() ? 'active' : '' }}">
                ...
                <!--end::Svg Icon-->
                <span class="theme-light-show small menu-title d-block">Aide</span>
                <span class="theme-dark-show small menu-title text-white d-block">Aide</span>
            </a>
        </li>
        <li class="nav-item">
            <a href={{route('facturation')}} class="nav-link text-center bg-active-light {{ 'factures' == request()->path() ? 'active' : '' }}">
                ...
                <!--end::Svg Icon-->
                <span class="theme-light-show small menu-title d-block">Factures</span>
                <span class="theme-dark-show small menu-title text-white d-block">Factures</span>
            </a>
        </li>
    </ul>
</nav>