                                                    ...
                                                    <div class="col-sm-6 ">
                                                        <div class="d-flex align-items-end flex-column">
                                                            ...
                                                            <div class="fw-bold fs-5 text-gray-800">
                                                                <p>
                                                                    <span>Reçu No: R-00{{$facture->id}}</span>
                                                                    <br>
                                                                    <span>{{\date('d/m/Y', \strtotime($facture->updated_at))}}</span>
                                                                </p>
                                                            </div>
                                                                <div class="fw-bold fs-6 text-gray-800">{{$transporteur->fullName()}}
                                                                </div>
                                                                ...
                                                                <div class="fw-semibold fs-7 text-gray-600">{{$transporteur->phoneNumber(true)}}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <table class="table mb-3">
                                                                <thead>
                                                                    <tr class="border-bottom fs-6 fw-bold text-muted">
                                                                        ...
                                                                        <th class="min-w-80px text-center pb-2">Expéditeur</th>
                                                                ...
                                                                <tbody>
                                                                    <tr class="fw-bold text-gray-700 fs-5 text-start">
                                                                        ...
                                                                        <td class="pt-6">{{$expediteur->fullName()}} </td>
