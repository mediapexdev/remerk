...
class ExpeditionsDepart extends Model
{
    ...
    /**
     * Get the full address of this expedition departure.
     *
    ...
    /**
     * Get the commune associated with this expedition departure.
     *
    ...
    /**
     * Get the departement associated with this expedition departure.
     *
    ...
    /**
     * Get the expedition associated with this expedition departure.
     *
    ...
    /**
     * Checks if the expedition associated with this expedition departure has a contact.
     *
     * Note : This method must be called as a method with the () because it is different from the methods of Eloquent.
     *
     * @return boolean
    ...
    /**
     * Get the region associated with this expedition departure.
     *
